            ...
            <div className="container df fdc aic g20">
                <a href="https://github.com/zaikinale/shop-react_with_backend.io" target="_blank"
                   className="portfolio__card df fdc aic block">
                    ...
                    <div className="portfolio__info">
                        ...
                        <p>Полноценный e-commerce сайт: каталог, карточки товара, отзывы, авторизация. Frontend — React
                            + TypeScript, бэкенд — Node.js + PostgreSQL.</p>
                    </div>
                </a>
                ...
                <a href="https://github.com/zaikinale/loyalty-telegram-app" target="_blank" className="portfolio__card df fdc aic block">
                    ...
                    <div className="portfolio__info">
                        ...
                        <p>Веб-интерфейс админки для Telegram-бота: управление клиентами, бонусами, уведомлениями.
                            Реализовано с использованием React, SCSS (БЭМ), REST API.</p>
                    </div>
                </a>
                ...
                <a href="https://github.com/zaikinale/task-manager-react" target="_blank" className="portfolio__card df fdc aic block">
                    ...
                    <div className="portfolio__info">
                        <h3>Task Manager</h3>
                        <p>Приложение для учёта задач с поддержкой статусов и дедлайнов. Использованы React, Zustand для
                            состояния, localStorage для хранения данных.</p>
                    </div>
                </a>
